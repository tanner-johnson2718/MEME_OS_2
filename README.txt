...
# Coding Style
- Distinct Modules will have their own .c and .h file(s) whose name the Modules
  name i.e. uart_8250.h
...
- Minimize magic number via pre-proc macros (as readability dictates)
