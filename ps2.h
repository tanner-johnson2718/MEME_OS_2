...
#define KEYBOARD_STATE_CAPSL_SHIFT    0
#define KEYBOARD_STATE_SHIFT_HELD_SHIFT 1
#define KEYBOARD_STATE_OUT_CAPS         2
#define KEYBOARD_STATE_SHIFT_CAPSL_MASK 0xfe
#define KEYBOARD_STATE_SHIFT_RELE_MASK  0xfd
#define KEYBOARD_STATE_CAPS_OFF_MASK    0xfb
